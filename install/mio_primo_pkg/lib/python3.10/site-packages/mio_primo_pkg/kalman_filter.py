...
class ExtendedKalmanFilter:
    ...
    def predict(self, imu_measurement):
        ...
        """
        Devo spostare self.pred_state nel metodo predict() in modo da poter fare il predict anche senza la misura della camera (IMU) gira più veloce e quindi potrei avere
        più
        """
